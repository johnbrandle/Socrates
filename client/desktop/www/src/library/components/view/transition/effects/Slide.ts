...
import { MotionBlurAssistant } from "../../../../assistants/MotionBlurAssistant";
import type { IBaseApp } from "../../../../IBaseApp";
import { DestructableEntity } from "../../../../../../../../../shared/src/library/entity/DestructableEntity";
import { easeOutQuad } from "../../../../assistants/TweenAssistant";
...
export class Slide<A extends IBaseApp<A>> extends DestructableEntity<A> implements ITransitionEffect<A>
{
    ...
    public async before(viewer:IViewer<A>, fromView:IView<A>, toView:IView<A>):Promise<void> 
    {
        ...
        else
        {
            ...
            const allowedAngles = [0, 45, 90];//[0, 33, 66, 90];
    ...
    public during(percent:number):void 
    {
        ...
        */
        ...
        if (percent < .40)
        {
            ...
            const rotationAngle = Math.abs(this._rotationAngle) === 90 ? 0 : this._rotationAngle;
