...
export class GridView<A extends IApp<A>> extends View<A>
{
    ...
    public readonly onTileClickedSignal = new Signal<[View<A>, folderpath | filepath]>(this);
    ...
    public override async init():Promise<void>
    {
        ...
        this._signalAssistant.subscribe(this._board.onTileClickedSignal, (_board, tileData) =>
        {
            this.onTileClickedSignal.dispatch(this, tileData.info!.path)
        });
