...
@ComponentDecorator()
export class Terminal<A extends IApp<A>> extends Window<A>
{
    constructor(app:A, destructor:IDestructor<A>, element:HTMLElement, appID:string, windowID:string, storage:IWindowStorage, displayOptions?:IWindowDisplayOptions) 
    {
