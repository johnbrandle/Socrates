...
import html from './TabBoard.html';
...
@ComponentDecorator()
export class TabBoard<A extends IApp<A>, D extends IStorageTileData> extends FitBoard<A, D, TabTile<A, D>>
{
    private _tileTemplateHTML?:string;

    public readonly onTileDoubleClickedSignal = new Signal<[TabBoard<A, D>, D]>(this);
    ...
    {
        type TileConstructor = typeof TabTile<A, D>;
