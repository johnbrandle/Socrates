//IMPORTANT - do not use console.error rather than console.log as we need console.log for outputting to stdout
...
export default (() =>
{
    ...
    {
        allowNet:true, 
        allowRead:[localConfig.rootPath, localConfig.cert, localConfig.key], 
        noNPM:true,
